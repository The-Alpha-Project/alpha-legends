...
namespace WorldServer.Game.Objects
{
    ...
    public class Player : Unit
    {
        ...
        public override PacketWriter BuildUpdate(UpdateTypes type = UpdateTypes.UPDATE_PARTIAL, bool self = false)
        {
            ...
            uc.UpdateValue<long>(UnitFields.UNIT_FIELD_RESISTANCES, (long)(Armor.BaseAmount + (Agility.Current * 2)));
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCES, Holy.BaseAmount, 1);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCES, Fire.BaseAmount, 2);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCES, Nature.BaseAmount, 3);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCES, Frost.BaseAmount, 4);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCES, Shadow.BaseAmount, 5);
            ...
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE, Armor.PositiveAmount);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE, Holy.PositiveAmount, 1);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE, Fire.PositiveAmount, 2);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE, Nature.PositiveAmount, 3);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE, Frost.PositiveAmount, 4);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE, Shadow.PositiveAmount, 5);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE, Armor.NegativeAmount);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE, Holy.NegativeAmount, 1);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE, Fire.NegativeAmount, 2);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE, Nature.NegativeAmount, 3);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE, Frost.NegativeAmount, 4);
            uc.UpdateValue<int>(UnitFields.UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE, Shadow.NegativeAmount, 5);
